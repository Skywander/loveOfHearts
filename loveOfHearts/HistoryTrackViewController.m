...
- (void)initButton {
    ...
    [searchButton setBackgroundColor:DEFAULT_COLOR];
    ...
    [overLabel setBackgroundColor:DEFAULT_COLOR];
...
- (void)clickSearchButton {
    ...
    [searchButton setTitleColor:DEFAULT_COLOR forState:UIControlStateNormal];
